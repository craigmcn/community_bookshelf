...
gem "jbuilder"
# CSV — removed from Ruby's default gems since 3.4, used for shelf export/import
gem "csv"
...
# Error tracking/APM — no-ops unless SENTRY_DSN is set, see config/initializers/sentry.rb
gem "sentry-ruby"
gem "sentry-rails"
